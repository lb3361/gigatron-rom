...
vPC = symbol('vPC')
vAC = symbol('vAC')
RacerHorizon = symbol('_RacerHorizon') or symbol('RacerHorizon')

#-----------------------------------------------------------------------
#       SYS_RacerUpdateVideoX_40
#-----------------------------------------------------------------------

# Reveals the addresses of rom based racer components

label('SYS_RacerInfoX_28')
ld(0,Y)                                       #15
ld(sysArgs,X)                                 #16
st('SYS_RacerUpdateVideoX_40',[Y,Xpp])        #17
st(hi('SYS_RacerUpdateVideoX_40'),[Y,Xpp])    #18
st('SYS_RacerUpdateVideoY_40',[Y,Xpp])        #19
st(hi('SYS_RacerUpdateVideoY_40'),[Y,Xpp])    #20
st(RacerHorizon,[Y,Xpp])                      #21
st(hi(RacerHorizon),[Y,Xpp])                  #22
ld(hi('REENTER'),Y)                           #23
jmp(Y,'REENTER')                              #24
ld(-28//2)                                    #25
