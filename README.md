...
Software for Gigatron ROM  (DEV7ROM)
=========================

This is a fork of the official Gigatron ROM software
containing some advanced ROM features such as [vCPU7](Docs/vCPU7.md),
[FSM framework](https://forum.gigatron.io/viewtopic.php?p=3714&hilit=fsm#p3714), and
[Gt1 compression](https://forum.gigatron.io/viewtopic.php?p=4139&hilit=fsm#p4139).
These developments are designed to be maximally compatible with the 
official ROMv6 except for a slightly faster execution and for the availability of new features.
They come with a permanent offer to include these advances into the official devrom.
...
gigatron-rom
 ...
 |     +--- vCPU7.md            [vCPU7] Documentation of the DEV7 specific opcodes.
...
Files generated by dev.asm.py
===============================

See `Makefile` for how to make these.
```
dev7.lst                        Generated listing with disassembly
dev7.rom                        ROM file for 27C1024 (PCB versions)
dev128k7.{lst,rom}              Specific version for 128K gigatron
                                with distinct pages for vcpu and framebuffer.
dev512k7.{lst,rom}              Specific version for the 512k gigatron
                                with support for hardware assisted video generation
```
...
0081      vFAS          [vCPU7] Sign byte for floating point accumulator
0082      vFAE          [vCPU7] Exponent byte for floating point accumulator
0083      vLAX          [vCPU7] Extension byte for long accumulator vLAC and fp mantissa.
0084-0087 vLAC          [vCPU7] Long integer accumulator. Fp accumulator mantissa.
0088-0089 vT2           [vCPU7] Destination register for copy ops
008a-008b vT3           [vCPU7] Source register for copy ops
008b-.... userVars2_v7  More space for program variables
...
01f0-...  vReset        vCPU routine to load and start Reset sequence
01f5      vIrqCtx_v7    [vCPU7] Page for vCPU vIRQ context saving (or zero)
...
$0d80-$11ff  | v6502 secondary interpreter                              |   |
             |                                                          |   |
$1200-$16ff  | More SYS functions and vCPU opcodes.                     |   |
             |                                                          |   |
$1700-$17ff  | vCPU page for prefix 35 opcodes                          |   |
             |                                                          |   |
$1800-$21ff  | More SYS functions and vCPU opcodes                      |   |
             |                                                          |   v
             +==========================================================+  ---
             |                                                          |   ^
             | Embedded vCPU/v6502 applications and data                |   |
$1200-$ffff  | serialized as compressed GT1 files                       |   |  cold storage
             |                                                          |   v
             +----------------------------------------------------------+  ---
              0                                                      255
```
