...
```
dev.lst                        Generated listing with disassembly
dev.rom                          ROM file for 27C1024 (PCB versions)
dev128k.lst                    Specific version for 128K gigatron
dev128k.rom                      with distinct pages for vcpu and framebuffer.
```
...
$1700-$17ff  | vCPU page for prefix 35 opcodes                          |   |
             |                                                          |   |
$1800-$23ff  | More SYS functions and vCPU opcodes                      |   |
             |                                                          |   v
             +==========================================================+  ---
             |                                                          |   ^
             | Embedded vCPU/v6502 applications and data                |   |
$2400-$ffff  | serialized as compressed GT1 files                       |   |  cold storage
             |                                                          |   v
             +----------------------------------------------------------+  ---
              0                                                      255
```
...
009e    SYS_Multiply_s16_v7_34          Compatible 16 bits multiplication
00a1    SYS_Divide_u16_v7_34            Compatible 16 bits unsigned division
00e0    SYS_DoubleDabble_v7_34          Helper for converting numbers to ASCII
